    ...
    <div className="bg-[#f0f6ff] overflow-hidden md:p-5 flex flex-col md:flex-row items-center justify-between w-full gap-4">
      <div className="w-full sm:w-[70%] md:w-[40%] p-4 sm:p-6 font-sans transition-all duration-500 ease-in-out">
        ...
        <p className="text-gray-700 mt-4 sm:mt-6 text-sm sm:text-base leading-relaxed">
          Planning with <strong>RioMoneyCurve</strong> & our advanced technology
          and secure systems provide a safe and reliable way to transfer funds,
          allowing you to benefit from reduced processing times and improved
          efficiency.
        </p>
      ...
      <div className="bg-[#f0f6ff] p-1 flex items-center justify-center w-full  md:w-[60%]">
        <div className="relative w-full">
          <div className="flex flex-row justify-center items-start gap-2 sm:gap-4  md:gap-10 mb-8">
            <div className="bg-white p-4 rounded-2xl shadow-md flex flex-col items-center transition-transform duration-300 hover:scale-[1.05] w-full sm:w-auto">
              ...
              <div className="mt-2 text-center">
                ...
                <p className="text-xs text-gray-500">game ninja</p>
              </div>
            </div>

            <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-md w-full sm:w-64 text-center transition-shadow duration-300 hover:shadow-xl">
              <img
                src={images.Money}
                alt="Controller"
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-md sm:text-xl font-semibold ">₹ 75.00</p>
            ...
            <div className="bg-white p-4 rounded-2xl shadow-md w-full sm:w-40 text-center font-semibold hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center sm:items-end gap-4 sm:gap-5 mt-8">
            <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-md w-full sm:w-96 text-xs sm:text-sm transition-transform duration-300 hover:scale-[1.02]">
              <p className="text-gray-700 mb-2">Authorize payment</p>
